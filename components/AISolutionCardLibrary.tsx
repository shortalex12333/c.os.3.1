...
export function AISolutionCardLibrary({ 
  ...
  // Extract variant properties with defaults
  const {
    state = 'expanded',
    confidence = 'high',
    mode = 'desktop', 
      ...
      {solutions.map((solution, index) => {
        ...
        return (
          <motion.div
            ...
            `}
            style={{
              borderRadius: '0px', // Zero border radius as specified
              borderColor: tokens.colors.border,
              backgroundColor: isExpanded ? tokens.colors.white : tokens.colors.white,
              ...(isExpanded && {
